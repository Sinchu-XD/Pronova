...
async def pronova_ultimate_animation(message: Message, user_name: str):
    ...
    buttons = InlineKeyboardMarkup([
        [InlineKeyboardButton("➕ Add to Group", url="https://t.me/ProNovaMusicBot?startgroup=true")],
        [InlineKeyboardButton("👑 VIP Channel", url="https://t.me/Her4Eva")]
    ])
